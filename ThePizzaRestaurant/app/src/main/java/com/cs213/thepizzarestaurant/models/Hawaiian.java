...
/**
 * Hawaiian pizza class for hawaiian pizza
 *
 * @author 
 */
public class Hawaiian extends Pizza {
     ...
     */
    private static final double mediumPrice = 12.99;
    /**
     * Price for large pizza
     */
    private static final double largePrice = 14.99;
    /**
     * Price for extra toppings
     */
    private static final double extraToppingPrice = 1.49;
    /**
     * Number of Minimum toppings required on pizza
     */
    private static final int minimumToppings = 2;

    /**
     * Default Constructor to initialize an instance of hawaiian pizza order
     */
    public Hawaiian() {
    ...
    /**
     * Constructor to initialize an instance of hawaiian pizza order
    ...
    public String toString() {
        ...
        String result = "Flavor-> Hawaiian :: Size-> " + this.size.toString()
